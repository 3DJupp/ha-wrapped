...
def claude_copy(stats, period_label, language="en", tone="dry, witty, deadpan",
                api_key=None, period_kind="yearly"):
    """Ask Claude for witty one-liners. Returns {} on any failure.

    `api_key` lets the add-on pass the key from its config; falls back to
    the ``ANTHROPIC_API_KEY`` env var for the CLI path. `period_kind`
    (``yearly``/``monthly``) keeps the intro/outro time scope right -- a
    monthly recap looks ahead to next month, not next year."""
    ...
    ahead = "next month" if period_kind == "monthly" else "next year"
    prompt = (
...
def collect_and_render(cfg, *, ha_url, token, ws_url, output=None,
    ...
    # intro_sub / outro_title come in a yearly and a monthly flavour -- the
    # "see you next year" line only makes sense for a yearly wrapped, a
    # monthly one says "next month". The right one is picked by `mode` below.
    i18n = {
        "en": {"scroll": "scroll", "trend": "trend",
               "theme": "light / dark",
               "intro_sub": {"yearly": "What your home got up to this year.",
                             "monthly": "What your home got up to this month."},
               "outro_title": {"yearly": "See you next year.",
                               "monthly": "See you next month."},
               "summary_title": "The Recap",
               "generated_by": "Generated by Home Assistant"},
        "de": {"scroll": "scrollen", "trend": "Verlauf",
               "theme": "Hell / Dunkel",
               "intro_sub": {"yearly": "Was dein Zuhause dieses Jahr so getrieben hat.",
                             "monthly": "Was dein Zuhause diesen Monat so getrieben hat."},
               "outro_title": {"yearly": "Bis nächstes Jahr.",
                               "monthly": "Bis nächsten Monat."},
               "summary_title": "Die Bilanz",
               "generated_by": "Erstellt mit Home Assistant"},
        "fr": {"scroll": "défiler", "trend": "tendance",
               "theme": "clair / sombre",
               "intro_sub": {"yearly": "Ce que votre maison a fait cette année.",
                             "monthly": "Ce que votre maison a fait ce mois-ci."},
               "outro_title": {"yearly": "À l'année prochaine.",
                               "monthly": "Au mois prochain."},
               "summary_title": "Le récap",
               "generated_by": "Généré par Home Assistant"},
        "es": {"scroll": "desplázate", "trend": "tendencia",
               "theme": "claro / oscuro",
               "intro_sub": {"yearly": "Lo que hizo tu casa este año.",
                             "monthly": "Lo que hizo tu casa este mes."},
               "outro_title": {"yearly": "Hasta el año que viene.",
                               "monthly": "Hasta el mes que viene."},
               "summary_title": "El resumen",
               "generated_by": "Generado por Home Assistant"},
        "it": {"scroll": "scorri", "trend": "andamento",
               "theme": "chiaro / scuro",
               "intro_sub": {"yearly": "Cosa ha combinato casa tua quest'anno.",
                             "monthly": "Cosa ha combinato casa tua questo mese."},
               "outro_title": {"yearly": "Al prossimo anno.",
                               "monthly": "Al prossimo mese."},
               "summary_title": "Il riepilogo",
               "generated_by": "Generato da Home Assistant"},
        "nl": {"scroll": "scroll", "trend": "trend",
               "theme": "licht / donker",
               "intro_sub": {"yearly": "Wat je huis dit jaar heeft uitgespookt.",
                             "monthly": "Wat je huis deze maand heeft uitgespookt."},
               "outro_title": {"yearly": "Tot volgend jaar.",
                               "monthly": "Tot volgende maand."},
               "summary_title": "De samenvatting",
               "generated_by": "Gegenereerd door Home Assistant"},
        "pt": {"scroll": "rolar", "trend": "tendência",
               "theme": "claro / escuro",
               "intro_sub": {"yearly": "O que a sua casa fez este ano.",
                             "monthly": "O que a sua casa fez este mês."},
               "outro_title": {"yearly": "Até para o ano.",
                               "monthly": "Até ao próximo mês."},
        ...
        "summary_title": "Recap",
        "generated_by": "Generated by Home Assistant"}
    # collapse the yearly/monthly flavour down to the active period's string
    for _k in ("intro_sub", "outro_title"):
        _v = i18n.get(_k)
        if isinstance(_v, dict):
            i18n[_k] = _v.get(mode) or _v.get("yearly") or ""
